...
2️⃣-🔍: **ACCESS** the catalogue [**HERE**](https://xanderhuggins.github.io/groundwater-SES-data-catalogue/searchable_library.html) or by clicking on the screenshot below. <br>
...
To download a `.csv` file of the library of datasets and their metadata click [here]() (_this link will activate following manuscript acceptance_) <br> 
