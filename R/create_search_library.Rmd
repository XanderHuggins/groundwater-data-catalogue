...
<div style="text-align: center; margin-bottom: 20px;">
  <img src="your-header-image.png" alt="Global Groundwater Catalogue" style="max-width: 100%; height: auto;">
</div>

<!-- BOX 1: about -->
<div style="border: 5px solid #00777D; padding: 10px; background-color: #f8f8f8; border-radius: 10px; margin-bottom: 20px;">
   <p> ❓**About**: this catalogue provides a searchable database of open-access global datasets relevant for global studies on groundwater in social-ecological and Earth systems.  <br>
...
<div style="border: 5px solid #00777D; padding: 10px; background-color: #f8f8f8; border-radius: 10px; margin-bottom: 20px;">
  ...
  We will release new versions periodically, and each release will be accompanied by a changelog.  All metadata pertaining to each release can be found in this GitHub repository <a href="https://github.com/XanderHuggins/groundwater-data-catalogue/tree/main/catalogue_metadata" target="_blank"> folder</a>.
  <span class="para-text">
...
<div style="margin-top: -0.3em; font-size: 0.9em; color: #6c757d;">
